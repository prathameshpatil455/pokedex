...
const CompareContainer = ({
    ...
    const createStatsArray = (
        types: pokemonTypeInterface[], statType:pokemonStatType 
        ) => {
      ...
      }
      {
        ...
        <div className="compare-element">
                                ...
                                pokemon?.types.map((type: pokemonTypeInterface) => {
                                    ...
                                    return (
                                        <div className="pokemon-type">
                                            ...
                                            className='pokemon-type-image' loading='lazy' />
                                        </div>
                                    );
                                })}
                        </div>
            ...
            <div className="compare-action-buttons">
                <button className="compare-btn" onClick={() => dispatch(addPokemonToList(pokemon))}>
                    Add
                </button>
